...
public class WifiP2pManager {
    ...
    /** @hide */
    public static final int SET_USER_AUTH                           = BASE + 74;
    /** @hide */
    public static final int SET_USER_AUTH_FAILED                    = BASE + 75;
    /** @hide */
    public static final int SET_USER_AUTH_SUCCEEDED                 = BASE + 76;

    /** @hide */
    public static final int USER_AUTH_REQUEST                       = BASE + 77;
    /** @hide */
    public static final int USER_AUTH_SHOW_PIN                      = BASE + 78;
   ...
   /**
    ...
    public void authorizeConnection(Channel c, boolean accept, String pin,
        ...
        if (accept) {
            c.mAsyncChannel.sendMessage(WifiP2pService.PEER_CONNECTION_USER_ACCEPT, 0,
                    c.putListener(listener), pin);
        } else {
            c.mAsyncChannel.sendMessage(WifiP2pService.PEER_CONNECTION_USER_REJECT, 0,
                    c.putListener(listener), pin);
        }
    }
}
