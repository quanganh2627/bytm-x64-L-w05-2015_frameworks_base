...
public class EthernetManager implements NetworkStateTracker {
    ...
    //@Override
    public void captivePortalCheckComplete(boolean isCaptivePortal) {
        // not implemented
    }
    ...
    public NetworkCapabilities getNetworkCapabilities() { return new NetworkCapabilities(); }
