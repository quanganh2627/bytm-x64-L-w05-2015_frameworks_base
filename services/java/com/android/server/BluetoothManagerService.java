...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    private void handleCoexSafeChannels(int minFreq, int maxFreq) {
        ...
        if (DBG) Log.d(TAG, "COEX_SAFECHANNELS : Building BR/EDR Channel Range for [" +
                             minFreq + ", " + maxFreq + "]");
        ...
        if (DBG) Log.d(TAG, "COEX_SAFECHANNELS : BR/EDR Channel Range : [" + BtLowerChannel +
                            ", " + BtUpperChannel + "]");
        ...
        if (DBG) Log.d(TAG, "COEX_SAFECHANNELS : LE Channel Range : [" + LeLowerChannel +
                            ", " + LeUpperChannel + "]");
            ...
            switch (msg.what) {
                ...
                case MESSAGE_UNREGISTER_STATE_CHANGE_CALLBACK:
                {
                    ...
                    if (callback != null) {
                        ...
                        if (DBG) Log.d(TAG,"Trying to unregister a null callback, skipping");
                    }
                    break;
                }
