 ...
 */
class TelephonyRegistry2 extends ITelephonyRegistry2.Stub {
    private static final String TAG = "TelephonyRegistry2";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_USER_SWITCHED: {
                    ...
                    TelephonyRegistry2.this.notifyCellLocation(mCellLocation);
                    break;
                }
            }
        }
    ...
    TelephonyRegistry2(Context context) {
    ...
    private void broadcastServiceStateChanged(ServiceState state) {
        ...
        Intent intent = new Intent(TelephonyIntents2.ACTION_SERVICE_STATE_CHANGED);
    ...
    private void broadcastDataConnectionStateChanged(int state,
        ...
        // required info.
        Intent intent = new Intent(TelephonyIntents2.ACTION_ANY_DATA_CONNECTION_STATE_CHANGED);
        intent.putExtra(PhoneConstants.STATE_KEY,
    ...
    private void broadcastDataConnectionFailed(String reason, String apnType) {
        Intent intent = new Intent(TelephonyIntents2.ACTION_DATA_CONNECTION_FAILED);
