 ...
 * @hide
 */
public interface TelephonyProperties2
{
    ...
    static final String PROPERTY_RIL_IMPL = "gsm.version.ril-impl2";
     ...
     *  CDMA networks.
     */
    static final String PROPERTY_OPERATOR_ALPHA = "gsm.operator2.alpha";
     ...
     *  CDMA networks.
     */
    static final String PROPERTY_OPERATOR_NUMERIC = "gsm.operator2.numeric";

    /** 'true' if the device is on a manually selected network
     *
     *  Availability: when registered to a network
     */
    static final String PROPERTY_OPERATOR_ISMANUAL = "operator2.ismanual";

    /** 'true' if the device is considered roaming on this network for GSM
     *  purposes.
     *  Availability: when registered to a network
     */
    static final String PROPERTY_OPERATOR_ISROAMING = "gsm.operator2.isroaming";
     ...
     *  CDMA networks.
     */
    static final String PROPERTY_OPERATOR_ISO_COUNTRY = "gsm.operator2.iso-country";
     ...
     * {@see BaseCommands#getLteOnCdmaMode()}
     */
    static final String PROPERTY_LTE_ON_CDMA_DEVICE = "telephony.lteOnCdmaDevice2";

    static final String CURRENT_ACTIVE_PHONE = "gsm.current.phone-type2";
     ...
     */
    static String PROPERTY_SIM_STATE = "gsm.sim2.state";

    /** The MCC+MNC (mobile country code+mobile network code) of the
     *  provider of the SIM. 5 or 6 decimal digits.
     *  Availablity: SIM state must be "READY"
     */
    static String PROPERTY_ICC_OPERATOR_NUMERIC = "gsm.sim2.operator.numeric";

    /** PROPERTY_ICC_OPERATOR_ALPHA is also known as the SPN, or Service Provider Name.
     *  Availablity: SIM state must be "READY"
     */
    static String PROPERTY_ICC_OPERATOR_ALPHA = "gsm.sim2.operator.alpha";

    /** ISO country code equivalent for the SIM provider's country code*/
    static String PROPERTY_ICC_OPERATOR_ISO_COUNTRY = "gsm.sim2.operator.iso-country";
     ...
     */
    static String PROPERTY_DATA_NETWORK_TYPE = "gsm.network2.type";

    /** Indicate if phone is in emergency callback mode */
    static final String PROPERTY_INECM_MODE = "ril.cdma.inecmmode2";
     ...
     */
    static final String PROPERTY_RESET_ON_RADIO_TECH_CHANGE = "persist.radio2.reset_on_switch";

    /**
     * Set to false to disable SMS receiving, default is
     * the value of config_sms_capable
     */
    static final String PROPERTY_SMS_RECEIVE = "telephony.sms2.receive";

    /**
     * Set to false to disable SMS sending, default is
     * the value of config_sms_capable
     */
    static final String PROPERTY_SMS_SEND = "telephony.sms2.send";
     ...
     */
    static final String PROPERTY_TEST_CSIM = "persist.radio2.test-csim";
    /**
     * The maximum times the user can retry the PIN before blocked
     */
    static String PROPERTY_SIM_PIN_RETRY_LEFT = "gsm.sim2.pin_retry_left";
