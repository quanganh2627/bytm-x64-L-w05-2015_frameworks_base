...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback,
    ...
    /* package */ final class TaskDescriptionAdapter extends BaseAdapter {
        ...
        public View createView(ViewGroup parent) {
            ...
            if (holder.containerView != null) {
                holder.containerView.setImageBitmap(mRecentTasksLoader.getDefaultIcon());
    ...
    private void updateIcon(ViewHolder h, Drawable icon, Drawable containerIcon, boolean show, boolean anim) {
        if (icon != null) {
    ...
    private void animateInIconOfFirstTask() {
        if (mItemToAnimateInWhenWindowAnimationIsFinished != null &&
            ...
            for (View v :
                // ARKHAM-276 - START Use icon to identify container activities
                new View[] { holder.iconView, holder.containerView, holder.labelView, holder.calloutLine }) {
                if (v != null) {
